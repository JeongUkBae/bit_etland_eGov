...
compo = {
		cust_login_form : ()=>{ 
			...
			+'			<input type="text" placeholder="Enter Username" name="uname" value="nagihozzang" "required">'
			+'		<label for="psw"><b>Password</b></label>'
			+'    		<input type="password" placeholder="Enter Password" name="psw" value="1111" "required">'
	          ...
	          +'<form class="needs-validation" novalidate="">'
	            +'<div class="row">'
	              +'<div class="col-md-6 mb-3">'
	                ...
	                +'<small class="text-muted"> 등록할 제품의 카테고리(스마트폰, 데스크탑...).</small>'
	              +'</div>'
	            ...
	            +'<hr class="mb-4">'
	            +'<div class="mb-3">'
	              +'<label for="price">가격 <span class="text-muted">(만원단위)</span></label>'
	              +'<input type="text" class="form-control" id="price"가격(만원단위)">'
