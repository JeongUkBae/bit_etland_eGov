...
compo = {
		cust_login_form : ()=>{ 
			...
			+'			<input type="text" placeholder="Enter Username" name="uname" value="as" "required">'
		...
		cust_join_form : ()=>{
			...
			+'<div class="clearfix">'
			+'<button type="button" class="cancelbtn">Cancel</button>'
			+'<button type="submit" class="signupbtn">Sign Up</button></div></div>'
			+'</form>'
		...
		emp_register_form : ()=>{
			return '<form style="border:1px solid #ccc">'
    		+'<div class="container">'
			+'<h1>사원가입</h1><p>Please fill in this form to create an account.</p><hr>'
			+'<label for="employeeID"><b>EmployeeID</b></label>'
			+'<input type="text" placeholder="Enter EmployeeID" name="employeeID" "required"="">'
			+'<label for="manager"><b>Manager</b></label>'
			+'<input type="password" placeholder="Enter Manager" name="manager" "required"="">'
			+'<label for="name"><b>Name</b></label>'
			...
			+'<div class="clearfix">'
			+'<button type="button" class="cancelbtn">Cancel</button>'
			+'<button type="submit" class="signupbtn">REGISTER</button></div></div>'
			+'</form>'
		},
		cust_mypage : ()=>{
			    ...
			    +'<div class="w3-third">'
			      +'<div class="w3-white w3-text-grey w3-card-4">'
			        ...
			        +'<div class="w3-container">'
			          ...
			          +'<hr>'
			          +'<button type="submit" class="update">정보수정</button>' //버튼 
			          +'<p>Adobe Photoshop</p>'
		...
		cust_update : ()=>{
			return '<form style="border:1px solid #ccc">'
    		+'<div class="container">'
			+'<h1>회원정보 수정</h1><p>Please fill in this form to create an account.</p><hr>'
	...
	+'</form>'
		...
		list : ()=>{
			...
			+'<div class="col-xs-6">'
					+'<h1><font id="srch_title" style="font-size: 30px">회원 리스트 </font></h1>'
				...
				+'<table id="cust_content" style="width: 100%" >'
				  ...
				  +'</tr>'
				+'</table>'
				+'<table id="cust_content_2" style="width: 100%" >'
				+'</table>'
				+'</div>'
			   +'</div>'
			  +'</div>	'
			...
			return '<div class="col-md-8 order-md-1">'
              ...
              +'</div>'
	            ...
	            +'<div class="d-block my-3">'
	              ...
	              +'  <input id="credit"  value="화이트" name="color" type="radio" class="custom-control-input" checked="" required="">'
	                +'<label class="radi custom-control-label" for="credit" >화이트</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="debit" value="블랙" name="color" type="radio" class="custom-control-input" required="">'
	                +'<label class="radi custom-control-label" for="debit" >블랙</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="paypal" value="블루" name="color" type="radio" class="custom-control-input" required="">'
	            ...
	            +'<div class="row">'
	              +'<div class="col-md-5 mb-5">'
	              	+'<form id="img_upload_frm" encType="multipart/from-data">'
	              ...
	              +'</div>'
	              +'<div class="col-md-5 mb-5">'
	              	+'<form id="img_drag_frm" encType="multipart/from-data">'
